...
execute as @a \
if score @s dash_charge matches 1.. \
if score @s dash_charge = @s dash_reset \
run scoreboard players set @s dash_charge 0

# Follow the reset counter but one tick behind
execute as @a run \
